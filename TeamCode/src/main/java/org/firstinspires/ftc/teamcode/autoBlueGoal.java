...
public class autoBlueGoal extends OpMode {
    ...
    public void init() {
        ...
        follower.setStartingPose(new Pose(21.484, 121.161, Math.toRadians(323)));
    ...
    public static class Paths {
        ...
        public Paths(Follower follower) {
            scorePreload = follower.pathBuilder().addPath(
                            new BezierLine(
                                    new Pose(21.484, 121.161),

                                    new Pose(58.645, 84.387)
                            )
                    ).setLinearHeadingInterpolation(Math.toRadians(323), Math.toRadians(318))

                    .build();

            rotatePPG = follower.pathBuilder().addPath(
                            new BezierLine(
                                    new Pose(58.645, 84.387),

                                    new Pose(51.871, 84.387)
                            )
            ...
            grabPPG = follower.pathBuilder().addPath(
                            new BezierLine(
                                    ...
                                    new Pose(18.387, 79.935)
                            )
                    ).setLinearHeadingInterpolation(Math.toRadians(180), Math.toRadians(180))

                    .build();

            scorePPG = follower.pathBuilder().addPath(
                            new BezierLine(
                                    new Pose(18.387, 79.935),

                                    new Pose(58.065, 84.387)
                            )
                    ).setLinearHeadingInterpolation(Math.toRadians(180), Math.toRadians(318))

                    .build();

            rotatePGP = follower.pathBuilder().addPath(
                            new BezierLine(
                                    new Pose(58.065, 84.387),

                                    new Pose(58.258, 58.065)
                            )
                    ).setLinearHeadingInterpolation(Math.toRadians(318), Math.toRadians(180))
            ...
            grabPGP = follower.pathBuilder().addPath(
                            new BezierLine(
                                    ...
                                    new Pose(17.419, 57.290)
                            )
                    ).setTangentHeadingInterpolation()

                    .build();

            scorePGP = follower.pathBuilder().addPath(
                            new BezierLine(
                                    new Pose(17.419, 57.290),

                                    new Pose(58.258, 84.581)
                            )
                    ).setLinearHeadingInterpolation(Math.toRadians(180), Math.toRadians(318))

                    .build();

            rotateGPP = follower.pathBuilder().addPath(
                            new BezierLine(
                                    new Pose(58.258, 84.581),

                                    new Pose(58.452, 32.516)
                            )
                    ).setLinearHeadingInterpolation(Math.toRadians(318), Math.toRadians(180))
            ...
            grabGPP = follower.pathBuilder().addPath(
                            new BezierLine(
                                    ...
                                    new Pose(17.226, 33.484)
                            )
                    ).setLinearHeadingInterpolation(Math.toRadians(180), Math.toRadians(180))

                    .build();

            scoreGPP = follower.pathBuilder().addPath(
                            new BezierLine(
                                    new Pose(17.226, 33.484),
            ...
            park = follower.pathBuilder().addPath(
                            new BezierLine(
                                    ...
                                    new Pose(16.645, 95.806)
                            )
                    ).setLinearHeadingInterpolation(Math.toRadians(318), Math.toRadians(360))
